...
IF OBJECT_ID('[uspGrantRevokeReadOnlyAccessRestricted]','P') IS NOT NULL DROP PROCEDURE [dbo].[uspGrantRevokeReadOnlyAccessRestricted]
GO

/****** Object:  StoredProcedure [dbo].[uspGrantRevokeReadOnlyAccessRestricted]    Script Date: 5/9/2019 9:48:18 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[uspGrantRevokeReadOnlyAccessRestricted] @LoginGroup varchar(255),  @AccessType VARCHAR(25)
/*******************************************************************************************
...
RunTime:	
Execution:	
					EXEC uspGrantRevokeReadOnlyAccessRestricted 'TPSINTERNAL\EC2 DB Group','Add'
					EXEC uspGrantRevokeReadOnlyAccessRestricted 'TPSINTERNAL\EC2 DB Group','Drop'
					EXEC uspGrantRevokeReadOnlyAccessRestricted 'TPSINTERNAL\EC2 DB Group','Add'
					EXEC uspGrantRevokeReadOnlyAccessRestricted 'TPSINTERNAL\EC2 BA Group','Add'
					EXEC uspGrantRevokeReadOnlyAccessRestricted 'TPSINTERNAL\EC2 BA Group','Drop'
					EXEC uspGrantRevokeReadOnlyAccessRestricted 'TPSINTERNAL\EC2 BI Group','Add'
					EXEC uspGrantRevokeReadOnlyAccessRestricted 'TPSINTERNAL\EC2 BI Group','Drop'
					EXEC uspGrantRevokeReadOnlyAccessRestricted 'TPSINTERNAL\EC2 Dev Group','Add'
					EXEC uspGrantRevokeReadOnlyAccessRestricted 'TPSINTERNAL\EC2 Dev Group','Drop'
					EXEC uspGrantRevokeReadOnlyAccessRestricted 'AgileDWorkbench','Add'
					EXEC uspGrantRevokeReadOnlyAccessRestricted 'AgileDWorkbench','Drop'
...
--SELECT * FROM #check
	...
	WHERE is_read_only = 0 AND NAME NOT IN ('model','master','msdb','tempdb') and name not like '%Lumen%'
	ORDER BY NAME
