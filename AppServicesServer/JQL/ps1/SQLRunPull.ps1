...
Invoke-Sqlcmd -Query "TRUNCATE TABLE APPLICATIONSERVICES_IM.dbo.AllProdRunTickets_FULL" -ServerInstance PROSHFASDB1
$Query = get-content C:\JQL\JQLRun.txt|Out-String
...
$bulkCopy.DestinationTableName = "AllProdRunTickets_FULL"
