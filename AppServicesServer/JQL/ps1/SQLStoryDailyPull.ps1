...
Invoke-Sqlcmd -Query "INSERT INTO APPLICATIONSERVICES_IM.dbo.AllProdStoryTickets_FULL SELECT * FROM APPLICATIONSERVICES_IM.dbo.AllProdStoryTickets_Daily TRUNCATE TABLE APPLICATIONSERVICES_IM.dbo.AllProdStoryTickets_Daily" -ServerInstance PROSHFASDB1
$Query = get-content C:\JQL\JQLStoryDaily.txt|Out-String
...
$bulkCopy.DestinationTableName = "AllProdStoryTickets_Daily"
