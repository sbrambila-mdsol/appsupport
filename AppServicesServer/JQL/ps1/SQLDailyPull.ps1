...
Invoke-Sqlcmd -Query "INSERT INTO APPLICATIONSERVICES_IM.dbo.AllProdIssueTickets_Full SELECT * FROM APPLICATIONSERVICES_IM.dbo.AllProdIssueTickets_Daily TRUNCATE TABLE APPLICATIONSERVICES_IM.dbo.AllProdIssueTickets_Daily" -ServerInstance PROSHFASDB1
...
$bulkCopy.DestinationTableName = "AllProdIssueTickets_Daily"
