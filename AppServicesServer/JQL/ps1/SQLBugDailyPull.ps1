...
Invoke-Sqlcmd -Query "INSERT INTO APPLICATIONSERVICES_IM.dbo.AllProdBugTickets_Full SELECT * FROM APPLICATIONSERVICES_IM.dbo.AllProdBugTickets_Daily TRUNCATE TABLE APPLICATIONSERVICES_IM.dbo.AllProdBugTickets_Daily" -ServerInstance PROSHFASDB1
$Query = get-content C:\JQL\JQLBugDaily.txt|Out-String
...
$bulkCopy.DestinationTableName = "AllProdBugTickets_Daily"
