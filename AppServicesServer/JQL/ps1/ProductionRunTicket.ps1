...
Summary='' + (Get-Date).DayOfWeek + ' Shire Daily Runs'
 Fields = @{
#  assignee = @{name='srajan@shyftanalytics.com'}
...
Invoke-WebRequest `
	...
	-Method Post `
	-Uri 'https://hooks.slack.com/services/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' | Out-Null
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUhnA/DKMUuOw8ZgfoduM8TcFj
# XYugghtoMIIDtzCCAp+gAwIBAgIQDOfg5RfYRv6P5WD8G/AwOTANBgkqhkiG9w0B
...
# KwYBBAGCNwIBBDAjBgkqhkiG9w0BCQQxFgQUWJDya3AgR+KMPMBoGo1xorFyIrkw
# DQYJKoZIhvcNAQEBBQAEggEAIUrIK5AY3ND8BD4tT9zRGl0cySt2S0IYja/qK6C/
# ow/WJeC2U4B8fbCk7nYCJ1qHP0MhrUT5aMi/grlejI4nIWq/oZnXXgVz/rmhYFni
# TBtRG8y1RD4I1saZc0mudkQJqE6iHQ8R6QLjFE7xsCAIdrM/J6Vpt6/ilLipMdET
# zGUOIUK9cE86n7Z29IUKQNJBdQygetaBW+qWsJiLYzSLfLa4CE7o6+rrAVZCZdzS
# frHaBHiWvMS3KaSc7jydkOjQengFtE3FYqu4dKSc30JEVX9RJdfms/UloUEoLPeE
# KmwAMR8NyViMEMELlZZwhMYLf5or8K2Ghn9yjcIEvZZq3qGCAg8wggILBgkqhkiG
...
# MjAwNTE0MTQwNDU0WjAjBgkqhkiG9w0BCQQxFgQUUfo8rcX2E3RCgkQ65UIf9HFe
# t2gwDQYJKoZIhvcNAQEBBQAEggEAmtrYvazwClxqrddf2CLfMCf1CorqBsWd6VSA
# bEvsHayx7hj4fZtgS/eaDE+aiZurHHGfCSCma1nFWUTbG26QGDXMQtmmseBQ+T+H
# eIMzds+UyD+7dMG6UnQxSsUltm43Zfo3zzYoEfUNKwTnGDBtGw8wDPjgVN4mcTJJ
# PrtEjlQh7b6QMpT/eaDTGAf1JSv1VX+A5bknJaK26yIsL/SVTDffriBVBKyRUj4k
# DlY0I6pF8GculpaW24L1MKQNqd9D8+Fh6/eB6cDT1uK14VabMlHFP2jKahlh6/sf
# w5jTxGuyFAvwPPALOT8AeJGOLQWHF0zzlsczvmBNKAkTCV/5xQ==
