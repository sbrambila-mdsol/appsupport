...
Invoke-Sqlcmd -Query "INSERT INTO APPLICATIONSERVICES_IM.dbo.AllProdDeployTickets_Full SELECT * FROM APPLICATIONSERVICES_IM.dbo.AllProdDeployTickets_Daily TRUNCATE TABLE APPLICATIONSERVICES_IM.dbo.AllProdDeployTickets_Daily" -ServerInstance PROSHFASDB1
$Query = get-content C:\JQL\JQLDeployDaily.txt|Out-String
...
$bulkCopy.DestinationTableName = "AllProdDeployTickets_Daily"
