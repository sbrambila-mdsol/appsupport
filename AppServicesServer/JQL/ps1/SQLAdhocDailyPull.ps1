...
Invoke-Sqlcmd -Query "INSERT INTO APPLICATIONSERVICES_IM.dbo.AllProdAdhocTickets_Full SELECT * FROM APPLICATIONSERVICES_IM.dbo.AllProdAdhocTickets_Daily TRUNCATE TABLE APPLICATIONSERVICES_IM.dbo.AllProdAdhocTickets_Daily" -ServerInstance PROSHFASDB1
$Query = get-content C:\JQL\JQLAdhocDaily.txt|Out-String
...
$bulkCopy.DestinationTableName = "AllProdAdhocTickets_Daily"
