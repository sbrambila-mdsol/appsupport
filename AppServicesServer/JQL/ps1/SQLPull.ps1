...
Invoke-Sqlcmd -Query "TRUNCATE TABLE APPLICATIONSERVICES_IM.dbo.AllProdIssueTickets_FULL" -ServerInstance PROSHFASDB1
$Query = get-content C:\JQL\JQL.txt|Out-String
...
$bulkCopy.DestinationTableName = "AllProdIssueTickets_Full"
