...
Invoke-Sqlcmd -Query "TRUNCATE TABLE APPLICATIONSERVICES_IM.dbo.AllProdStoryBIVisTickets_FULL" -ServerInstance PROSHFASDB1
$Query = get-content C:\JQL\JQLStoryBiVis.txt|Out-String
...
$bulkCopy.DestinationTableName = "AllProdStoryBIVisTickets_FULL"
