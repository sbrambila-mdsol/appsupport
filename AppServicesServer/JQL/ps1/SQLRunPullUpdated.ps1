...
Invoke-Sqlcmd -Query "TRUNCATE TABLE APPLICATIONSERVICES_IM.dbo.AllProdRunTickets_FULLv2" -ServerInstance PROSHFASDB1
$Query = get-content C:\JQL\JQLRunUpdated.txt|Out-String
...
$bulkCopy.DestinationTableName = "AllProdRunTickets_FULLv2"
