...
Invoke-Sqlcmd -Query "INSERT INTO APPLICATIONSERVICES_IM.dbo.AllProdStoryBiVisTickets_FULL SELECT * FROM APPLICATIONSERVICES_IM.dbo.AllProdStoryBIVisTickets_Daily TRUNCATE TABLE APPLICATIONSERVICES_IM.dbo.AllProdStoryBiVisTickets_Daily" -ServerInstance PROSHFASDB1
$Query = get-content C:\JQL\JQLStoryBiVisDaily.txt|Out-String
...
$bulkCopy.DestinationTableName = "AllProdStoryBiVisTickets_Daily"
