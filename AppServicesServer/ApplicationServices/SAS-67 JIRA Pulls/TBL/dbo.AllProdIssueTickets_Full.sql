...
IF EXISTS (SELECT OBJECT_ID FROM SYS.TABLES WHERE NAME='AllProdIssueTickets_Full') DROP TABLE dbo.AllProdIssueTickets_Full

/****** Object:  Table [dbo].[AllProdIssueTickets_Full]    Script Date: 5/17/2019 4:19:07 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[AllProdIssueTickets_Full](
