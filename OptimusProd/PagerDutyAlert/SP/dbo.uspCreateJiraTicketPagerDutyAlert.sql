...
/****** Object:  StoredProcedure [dbo].[uspCreateJiraTicketPagerDutyAlert]    Script Date: 12/2/2019 4:54:50 PM ******/
DROP PROCEDURE IF EXISTS [dbo].[uspCreateJiraTicketPagerDutyAlert]
GO
...
CREATE PROCEDURE [dbo].[uspCreateJiraTicketPagerDutyAlert]
/*******************************************************************************************
Name:               uspCreateJiraTicketPagerDutyAlert
...
Execution:          EXEC TPS_DBA.dbo.uspCreateJiraTicketPagerDutyAlert 
NOTES:
 USEFUL SELECTS:
